...
import com.juan.arrivedrivers.OpInterface;
...
public class BaseActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tBaseCorreo= (TextView) hView.findViewById(R.id.tNaveCorreo);
        tBaseNombre= (TextView) hView.findViewById(R.id.tNaveNombre);
        //imageView= (ImageView) hView.findViewById(R.id.imgNavProfile);
        circleImageView= (CircleImageView) hView.findViewById(R.id.imgNavProfile);
        ...
        if(opc!=null){
            if(opc.equals("2") | opc.equals("3")){
                ...
                Picasso.with(getApplicationContext()).load(profileimg).resize(200,200).into(circleImageView);
            }
            else{
                opc="1";
            }
